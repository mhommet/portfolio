    ...
    <div className="navbar bg-base-100 sticky top-0 z-30 shadow-md">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
            <li><Link href={`/${lng}`}>{t('header.home')}</Link></li>
            <li><Link href={`/${lng}/#about`}>{t('header.about')}</Link></li>
      ...
      <div className="navbar-end">
        <div className="flex items-center gap-2 mr-2">
          <a href="https://github.com/mhommet" target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-circle">
            <FaGithub size={24} />
          </a>
