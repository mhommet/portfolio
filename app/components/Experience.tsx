...
export default function Experience({ lng }: ExperienceProps): React.ReactElement {
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="alert alert-info shadow-lg mt-12 w-full lg:w-3/4 mx-auto">
                    ...
                    <div className="ml-auto">
                        <a
                            href="#contact"
                            className="btn btn-ghost bg-white text-info hover:bg-info hover:text-white font-medium"
                        >
